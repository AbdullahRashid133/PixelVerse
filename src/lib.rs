...
#[derive(Debug)]
pub struct PixelVerseProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PixelVerseProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PixelVerse processing");
    
    let mut processor = PixelVerseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PixelVerseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PixelVerseProcessor::new(false);
